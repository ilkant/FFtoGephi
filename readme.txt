Here is two python tools to get names and cM values to matches from FTDNA FF match list.

First download from FTDNA FF-matches list to your computer as filename.csv. Then you can make two files from it.
